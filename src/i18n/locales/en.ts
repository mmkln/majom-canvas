export const en = {
  ...
  'existingPicker.goalTagApply': 'Filter by tag {tag}',
  'existingPicker.goalTagFilters': 'Filtered by tags',
  'existingPicker.goalTagFiltersClear': 'Clear tags',
  'existingPicker.goalTagLoading': 'Loading tag filters...',
  'existingPicker.goalTagLoadFailed': 'Failed to load tag filters.',
  'existingPicker.goalTagRemove': 'Remove tag filter {tag}',
  ...
  'existingPicker.goalSummaryMixed': 'Matching "{term}" within {tags}',
  'existingPicker.goalSummaryTags': 'Filtering by {tags}',
  'existingPicker.goalSummaryText': 'Matching "{term}"',
  'existingPicker.goalEmptyMixed': 'No goals match "{term}" within {tags}',
  'existingPicker.goalEmptySubtitleMixed':
    'Try clearing the text or removing one of the active tag filters.',
  'existingPicker.goalEmptySubtitleTags':
    'Try removing a tag filter or clearing all active filters.',
  'existingPicker.goalEmptySubtitleText':
    'Try a different keyword or add a #tag filter.',
  'existingPicker.goalEmptyTags': 'No goals are tagged {tags}',
  'existingPicker.goalEmptyText': 'No goals match "{term}"',
  'existingPicker.goalErrorMixed':
    'Failed to load goals matching "{term}" within {tags}',
  'existingPicker.goalErrorSubtitle':
    'Try again or clear one of the active filters.',
  'existingPicker.goalErrorTags': 'Failed to load goals filtered by {tags}',
  'existingPicker.goalErrorText': 'Failed to load goals matching "{term}"',
  'existingPicker.goalSearchOmniboxPlaceholder': 'Search goals or type #tag...',
  ...
  'relatedItems.addAllMissingGoals': 'Add all missing goals ({count})',
  ...
  'canvasMenu.sectionTitle': 'Canvas menu',
  ...
  'planningDetails.description.placeholder': 'No description yet.',
  'planningDetails.description.preview':
    'Description preview. Press Enter to edit.',
  'planningDetails.actions.openDetails': 'Open details',
  'planningDetails.actions.openDetailsFor': 'Open details for {title}',
  'planningDetails.field.description': 'Description',
  'planningDetails.field.priority': 'Priority',
  'planningDetails.field.scale': 'Scale',
  'planningDetails.field.status': 'Status',
  'planningDetails.field.tags': 'Tags',
  'planningDetails.field.title': 'Title',
  'planningDetails.field.untitled': 'Untitled',
  'planningDetails.goal.addRelation.chooseGoal': 'Choose a goal',
  'planningDetails.goal.addRelation.clearSearch': 'Clear goal search',
  'planningDetails.goal.addRelation.create': 'Create relation',
  'planningDetails.goal.addRelation.createFailed':
    'Failed to create the relation.',
  ...
  'planningDetails.goal.addRelation.option.blocksHint':
    'This goal prevents the selected goal from moving forward.',
  'planningDetails.goal.addRelation.option.follows': 'Follows',
  'planningDetails.goal.addRelation.option.followsHint':
    'This goal comes after the selected goal.',
  'planningDetails.goal.addRelation.option.leadsTo': 'Leads to',
  'planningDetails.goal.addRelation.option.leadsToHint':
    'This goal comes before the selected goal.',
  'planningDetails.goal.addRelation.option.relatesTo': 'Relates to',
  'planningDetails.goal.addRelation.option.relatesToHint':
    'These goals are related without a strict sequence.',
  'planningDetails.goal.addRelation.preview': 'Preview',
  'planningDetails.goal.addRelation.previewText.blockedBy': 'is blocked by',
  'planningDetails.goal.addRelation.previewText.blocks': 'blocks',
  'planningDetails.goal.addRelation.previewText.follows': 'follows',
  'planningDetails.goal.addRelation.previewText.leadsTo': 'leads to',
  'planningDetails.goal.addRelation.previewText.relatesTo': 'relates to',
  'planningDetails.goal.addRelation.relation': 'Relation',
  'planningDetails.goal.addRelation.searchEmpty': 'No goals match this query.',
  'planningDetails.goal.addRelation.searchFailed':
    'Failed to load goals for relation search.',
  'planningDetails.goal.addRelation.searchHint':
    'Search for a goal to relate to the current goal.',
  'planningDetails.goal.addRelation.searchLoading': 'Loading goals...',
  'planningDetails.goal.addRelation.searchPlaceholder': 'Search goals...',
  'planningDetails.goal.addRelation.targetGoal': 'Goal',
  'planningDetails.goal.addRelation.targetGoalUnavailable':
    'The selected goal is not available for relation creation.',
  'planningDetails.goal.addRelation.title': 'Add relation',
  'planningDetails.goal.newStoryTitle': 'New Story',
  'planningDetails.goal.relatedGoals.add': 'Add relation',
  ...
  'planningDetails.goal.relatedGoals.relation.follows': 'Follows',
  'planningDetails.goal.relatedGoals.relation.leadsTo': 'Leads to',
  'planningDetails.goal.relatedGoals.relation.relatesTo': 'Relates to',
  'planningDetails.goal.relatedGoals.statusTitle': 'Goal status: {status}',
  'planningDetails.goal.relatedGoals.title': 'Related goals ({count})',
  'planningDetails.goal.relatedGoals.notOnCanvas': 'Goal is not on this canvas',
  ...
  'planningDetails.goal.relatedGoals.updateFailed':
    'Failed to update the relation type.',
  'planningDetails.goal.scale.large': 'Large',
  'planningDetails.goal.scale.largeTitle':
    'Large scope. Complex goal with multiple milestones.',
  'planningDetails.goal.scale.medium': 'Medium',
  'planningDetails.goal.scale.mediumTitle':
    'Moderate scope. Requires coordination across a few steps.',
  'planningDetails.goal.scale.small': 'Small',
  'planningDetails.goal.scale.smallTitle':
    'Small scope. Quick to deliver with minimal dependencies.',
  'planningDetails.goal.stories.actions': 'Story actions',
  'planningDetails.goal.stories.actionsFor': 'Story actions for {title}',
  'planningDetails.goal.stories.create': 'Create story',
  'planningDetails.goal.stories.edit': 'Edit story',
  'planningDetails.goal.stories.empty': 'No stories in this goal.',
  'planningDetails.goal.stories.hide': 'Hide stories',
  'planningDetails.goal.stories.loadFailed': 'Failed to load goal stories.',
  'planningDetails.goal.stories.loading': 'Loading goal stories...',
  'planningDetails.goal.stories.new': 'New story',
  'planningDetails.goal.stories.notOnCanvas': 'Story is not on this canvas',
  'planningDetails.goal.stories.selectOnCanvas': 'Select on canvas',
  'planningDetails.goal.stories.statusTitle': 'Story status: {status}',
  'planningDetails.goal.stories.title': 'Stories',
  'planningDetails.goal.stories.toggle': 'Toggle stories hierarchy',
  'planningDetails.goal.tags.createFailed': 'Failed to create tag.',
  'planningDetails.goal.tags.loadFailed': 'Failed to load tags.',
  'planningDetails.goal.tasks.empty': 'No tasks in this story.',
  'planningDetails.goal.tasks.hide': 'Hide tasks',
  'planningDetails.goal.tasks.loadFailed': 'Failed to load story tasks.',
  'planningDetails.goal.tasks.loading': 'Loading story tasks...',
  'planningDetails.goal.tasks.notOnCanvas': 'Task is not on this canvas',
  'planningDetails.goal.tasks.statusTitle': 'Task status: {status}',
  'planningDetails.goal.tasks.title': 'Tasks',
  'planningDetails.hierarchy.hide': 'Hide hierarchy',
  'planningDetails.hierarchy.show': 'Show hierarchy',
  ...
  'planningDetails.priority.highTitle':
    'High urgency. Should be scheduled and completed soon.',
  'planningDetails.priority.lowestTitle':
    'Lowest priority. Can be ignored for now.',
  'planningDetails.priority.lowTitle':
    'Low urgency. Important, but not time-sensitive.',
  'planningDetails.priority.mediumTitle':
    'Balanced priority for regular planning and execution.',
  'planningDetails.story.newTaskTitle': 'New Task',
  'planningDetails.story.tasks.actions': 'Task actions',
  'planningDetails.story.tasks.actionsFor': 'Task actions for {title}',
  'planningDetails.story.tasks.create': 'Create task',
  'planningDetails.story.tasks.edit': 'Edit task',
  'planningDetails.story.tasks.empty': 'No tasks in this story.',
  'planningDetails.story.tasks.hide': 'Hide tasks',
  'planningDetails.story.tasks.loadFailed': 'Failed to load story tasks.',
  'planningDetails.story.tasks.loading': 'Loading story tasks...',
  'planningDetails.story.tasks.new': 'New task',
  'planningDetails.story.tasks.notOnCanvas': 'Task is not on this canvas',
  'planningDetails.story.tasks.selectOnCanvas': 'Select on canvas',
  'planningDetails.story.tasks.statusTitle': 'Task status: {status}',
  'planningDetails.story.tasks.title': 'Tasks',
  'planningDetails.story.tasks.toggle': 'Toggle tasks hierarchy',
  'planningDetails.title.emptyPreview': 'Untitled. Press Enter to add title.',
  'planningDetails.title.preview': 'Title preview. Press Enter to edit.',
  'planningDetails.validation.titleRequired': 'Title is required',
  'common.undo': 'Undo',
  ...
  'habits.summary.doneCount': '{count} done',
  'habits.summary.leftCount': '{count} left',
  'habits.summary.remainingToday': 'Remaining today: {count}',
  'habits.table.routine': 'Routine',
  'notes.activeNotice': 'Visible in active notes.',
  'notes.archivedNotice': 'Stored in archived notes.',
  'notes.bodyPlaceholder': 'Capture the detail, context, or next thought here.',
  'notes.delete.confirmMessage':
    'Are you sure you want to delete "{note}" permanently? This action cannot be undone.',
  'notes.delete.confirmTitle': 'Delete note permanently?',
  'notes.empty': 'No active notes yet.',
  'notes.emptyArchived': 'No archived notes.',
  'notes.emptySearch': 'No notes match the current search.',
  'notes.editMode': 'Edit',
  'notes.error.archive': 'Failed to update note status.',
  'notes.error.create': 'Failed to create note.',
  'notes.error.delete': 'Failed to delete note.',
  ...
  'notes.noSelectionBody':
    'Choose a note from the list or create a new one to start capturing context.',
  'notes.noSelectionTitle': 'No note selected',
  'notes.pin': 'Pin note',
  ...
  'notes.tab.active': 'Active ({count})',
  'notes.tab.archived': 'Archived ({count})',
  ...
  'login.privateWorkspaceNote': 'Your workspace stays private to your account.',
  ...
  'selectionMenu.applyAddTags': 'Add tags',
  'selectionMenu.applyRemoveTags': 'Remove tags',
  'selectionMenu.applyReplaceTags': 'Replace tags',
  ...
  'selectionMenu.changeConnectionRelation': 'Change relation type',
  'selectionMenu.removeConnectionEverywhere': 'Delete everywhere',
  'selectionMenu.removeConnectionFromCanvas': 'Delete from Canvas',
  'selectionMenu.removeTags': 'Remove',
  'selectionMenu.removeConnections': 'Remove connections',
  'selectionMenu.removeFromCanvas': 'Remove from Canvas',
  'selectionMenu.rotateClockwise': 'Rotate 90°',
  ...
  'flows.errors.load': 'Could not load flows.',
  'flows.actions.delete': 'Delete',
  'flows.actions.edit': 'Edit',
  'flows.actions.hideFlow': 'Hide flow',
  'flows.actions.menu': 'Flow actions',
  ...
  'flows.colors.amber': 'Amber',
  'flows.colors.blue': 'Blue',
  'flows.colors.cyan': 'Cyan',
  'flows.colors.emerald': 'Emerald',
  'flows.colors.fuchsia': 'Fuchsia',
  'flows.colors.indigo': 'Indigo',
  'flows.colors.lime': 'Lime',
  'flows.colors.orange': 'Orange',
  'flows.colors.rose': 'Rose',
  'flows.colors.slate': 'Slate',
  'flows.colors.teal': 'Teal',
  'flows.colors.violet': 'Violet',
  'flows.collapse': 'Collapse flow',
  ...
  'flows.delete.confirm': 'Delete "{title}"?',
  'flows.defaultFlowTitle': 'New flow',
  'flows.edit.cancel': 'Cancel',
  'flows.edit.appearance': 'Appearance',
  'flows.edit.close': 'Close flow settings',
  'flows.edit.color': 'Theme Color',
  ...
  'flows.edit.timeProfile': 'Time Profile',
  'flows.edit.timeProfilePlaceholder': 'e.g. 1h/d',
  'flows.edit.title': 'Flow Settings',
  'flows.expand': 'Expand flow',
  'flows.fields.priority': 'Priority',
  'flows.fields.status': 'Status',
  'flows.focus.add': 'Add Focus',
  'flows.focus.closeReason': 'Close reason',
  'flows.focus.closeReasonPlaceholder': 'Why this focus can be closed',
  'flows.focus.complete': 'Complete focus',
  'flows.focus.completeSave': 'Complete focus',
  'flows.focus.completeTitle': 'Complete Focus',
  'flows.focus.createTitle': 'New Focus',
  'flows.focus.description': 'Description',
  'flows.focus.descriptionPlaceholder': 'Optional context',
  'flows.focus.edit': 'Edit focus',
  'flows.focus.editTitle': 'Edit Focus',
  'flows.focus.endDate': 'End Date',
  'flows.focus.error': 'Could not save focus.',
  'flows.focus.errors.completeEvidence':
    'Add evidence or an explicit close reason.',
  'flows.focus.errors.required': 'Title and success criteria are required.',
  'flows.focus.evidence': 'Evidence',
  'flows.focus.evidencePlaceholder': 'Links, screenshots, notes, or proof',
  'flows.focus.evidenceRequired': 'Evidence Required',
  'flows.focus.evidenceRequiredPlaceholder': 'What proof will close this focus',
  'flows.focus.saving': 'Saving...',
  'flows.focus.startDate': 'Start Date',
  'flows.focus.status.active': 'Active',
  'flows.focus.status.archived': 'Archived',
  'flows.focus.status.candidate': 'Candidate',
  'flows.focus.status.completed': 'Completed',
  'flows.focus.status.draft': 'Draft',
  'flows.focus.status.failed': 'Failed',
  'flows.focus.status.paused': 'Paused',
  'flows.focus.successCriteria': 'Success Criteria',
  'flows.focus.successCriteriaPlaceholder':
    'What must be true when this is done',
  'flows.focus.titleLabel': 'Title',
  'flows.focus.titlePlaceholder': 'Build one proof-bearing mini case',
  'flows.focus.type': 'Focus Type',
  'flows.focus.types.cycle': 'Cycle',
  'flows.focus.types.experiment': 'Experiment',
  'flows.focus.types.maintenance': 'Maintenance',
  'flows.focus.types.milestone': 'Milestone',
  'flows.focus.types.mission': 'Mission',
  'flows.focus.types.objective': 'Objective',
  'flows.focus.types.stage': 'Stage',
  'flows.focus.typeHints.cycle':
    'Use when the work is a repeatable loop, not a one-time finish. Examples: weekly content sprint, monthly reporting cycle, daily outreach loop.',
  'flows.focus.typeHints.experiment':
    'Use when the answer is unknown and you need evidence before deciding. Examples: test a new offer, try a pricing angle, validate one automation idea.',
  'flows.focus.typeHints.maintenance':
    'Use when the goal is to keep the line healthy and prevent decay. Examples: fix broken automations, keep client reporting stable, clean inbox/process debt.',
  'flows.focus.typeHints.milestone':
    'Use for a checkpoint that proves progress but is not the whole process. Examples: first demo ready, contract signed, onboarding checklist closed.',
  ...
  'flows.focus.typeHints.objective':
    'Use when you want to reach a target state, not just ship an artifact. Examples: pipeline has 10 qualified leads, support response time under 1 day, onboarding is reliable.',
  'flows.focus.typeHints.stage':
    'Use when the flow needs to move to the next maturity level. Examples: from manual to repeatable, from prototype to client-ready, from messy to documented.',
  'flows.icons.academicCap': 'Learning',
  'flows.icons.barChart': 'Metrics',
  'flows.icons.bookClosed': 'Book',
  'flows.icons.bookOpen': 'Reading',
  'flows.icons.brain': 'Thinking',
  'flows.icons.car': 'Car',
  'flows.icons.codeBrackets': 'Code Brackets',
  'flows.icons.commandLine': 'Code',
  'flows.icons.computerDesktop': 'Desktop',
  'flows.icons.cookingPot': 'Cooking',
  'flows.icons.currencyDollar': 'Money',
  'flows.icons.dumbbell': 'Training',
  'flows.icons.folder': 'Folder',
  'flows.icons.health': 'Health',
  'flows.icons.heart': 'Heart',
  'flows.icons.lotus': 'Lotus',
  'flows.icons.notebook': 'Notebook',
  'flows.icons.paw': 'Paw',
  'flows.icons.plane': 'Travel',
  'flows.icons.plant': 'Growth',
  'flows.icons.popcorn': 'Entertainment',
  'flows.loading': 'Loading flows...',
  'flows.openTasks': 'open',
  'flows.status.active': 'Active',
  'flows.status.archived': 'Archived',
  'flows.status.cancelled': 'Cancelled',
  'flows.status.completed': 'Completed',
  'flows.status.described': 'Described',
  'flows.status.draft': 'Draft',
  'flows.tasks.add': 'Add Task',
  'flows.tasks.placeholder': 'Enter task title',
  'flows.tasks.titleLabel': 'Task title',
  'flows.tasks.empty': 'Empty flow',
  'flows.tasks.errors.create': 'Could not create task.',
  'flows.tasks.errors.load': 'Could not load tasks.',
  'flows.tasks.loading': 'Loading tasks...',
  'tasks.edit.title': 'Edit task',
  'tasks.edit.titleField': 'Title',
  'tasks.edit.description': 'Description',
  'tasks.edit.status': 'Status',
  'tasks.edit.priority': 'Priority',
  'tasks.edit.dueDate': 'Due date',
  'tasks.edit.goal': 'Goal',
  'tasks.edit.story': 'Story',
  'tasks.edit.goalPlaceholder': 'Select goal',
  'tasks.edit.storyPlaceholder': 'Select story',
  'tasks.edit.goalSearchPlaceholder': 'Search goals...',
  'tasks.edit.storySearchPlaceholder': 'Search stories...',
  'tasks.edit.clearRelation': 'Clear',
  'tasks.edit.clearSearch': 'Clear search',
  'tasks.edit.loadingOptions': 'Loading...',
  'tasks.edit.goalEmpty': 'No goals found',
  'tasks.edit.storyEmpty': 'No stories found',
  'tasks.edit.goalHint': 'Search for a goal',
  'tasks.edit.storyHint': 'Search for a story',
  'tasks.edit.saving': 'Saving...',
  'tasks.edit.loading': 'Loading task...',
  'tasks.edit.errors.load': 'Could not load task.',
  'tasks.edit.errors.save': 'Could not save task.',
  'tasks.edit.errors.delete': 'Could not delete task.',
  'tasks.edit.errors.relationSearch': 'Could not load options.',
  'tasks.edit.errors.titleRequired': 'Title is required',
  'tasks.edit.actions': 'Task actions',
  'tasks.edit.delete': 'Delete task',
  'tasks.edit.deleting': 'Deleting...',
  ...
  'workspaceControls.notes': 'Notes',
  'workspaceControls.pinControls': 'Pin workspace controls',
  'workspaceControls.openNotes': 'Open notes',
  ...
  'boards.import.action.conflict': 'Conflict',
  'boards.import.action.create': 'Create',
  'boards.import.action.skip': 'Skip',
  'boards.import.action.update': 'Update',
  'boards.import.actions.importBoard': 'Import board',
  'boards.import.actions.importCard': 'Import card',
  'boards.import.actions.importColumn': 'Import list',
  'boards.import.applied': 'Import applied.',
  ...
  'boards.import.entity.checklist': 'checklist',
  'boards.import.entity.column': 'list',
  ...
  'boards.import.match.title': 'Title',
  'boards.import.missing.clearOnReplace': 'Clear on replace',
  'boards.import.missing.keepExisting': 'Keep existing',
  'boards.import.missing.useDefaults': 'Use defaults',
  'boards.import.missingFields': 'Missing fields',
  'boards.import.mode': 'Import mode',
  'boards.import.mode.create': 'Create',
  'boards.import.mode.merge': 'Merge',
  'boards.import.mode.replace': 'Replace',
  ...
  'boards.import.unknown.strict': 'Strict error',
  'boards.import.unknown.warn': 'Warn and ignore',
  'boards.import.unknownFields': 'Unknown fields',
  'boards.export.actions.boardJson': 'Export board as JSON',
  'boards.export.actions.boardMarkdown': 'Export board as Markdown',
  'boards.export.actions.cardJson': 'Export card as JSON',
  'boards.export.actions.cardMarkdown': 'Export card as Markdown',
  'boards.export.actions.columnJson': 'Export list as JSON',
  'boards.export.actions.columnMarkdown': 'Export list as Markdown',
  'boards.export.copied': 'Export copied.',
  'boards.export.copy': 'Copy',
  'boards.export.copyFailed': 'Select the export text and copy it manually.',
  'boards.export.failed': 'Could not export this item.',
  'boards.export.title.board': 'Export board',
  'boards.export.title.card': 'Export card',
  'boards.export.title.column': 'Export list',
  ...
  'boards.boardPicker.noResults': 'No boards found.',
  'boards.boardPicker.open': 'Switch board',
  'boards.boardPicker.recent': 'Recent',
  'boards.boardPicker.removeFromGroup': 'Remove from group',
  'boards.boardPicker.searchLabel': 'Search boards',
  'boards.boardPicker.searchPlaceholder': 'Search your boards',
  'boards.boardPicker.star': 'Star board',
  'boards.boardPicker.starred': 'Starred',
  'boards.boardPicker.unstar': 'Unstar board',
  'boards.boardPicker.yourBoards': 'Your boards',
  ...
  'boards.cardBack.addChecklist': 'Add checklist',
  'boards.cardBack.addItem': 'Add item',
  'boards.cardBack.addLabel': 'Add a label',
  'boards.cardBack.assign': 'Assign',
  ...
  'boards.cardBack.checkItemPlaceholder': 'Add an item',
  'boards.cardBack.checkItemActions': 'Actions for checklist item {title}',
  'boards.cardBack.checklistTitle': 'Title',
  'boards.cardBack.checklistTitlePlaceholder': 'Checklist title',
  'boards.cardBack.checklistsLoadFailed': 'Failed to load checklists.',
  'boards.cardBack.checklistsLoading': 'Loading checklists...',
  'boards.cardBack.checklistsSaveFailed': 'Failed to save checklist changes.',
  ...
  'boards.cardBack.deleteCheckItem': 'Delete checklist item {title}',
  'boards.cardBack.deleteChecklist': 'Delete checklist {title}',
  'boards.cardBack.dates': 'Dates',
  'boards.cardBack.defaultChecklistTitle': 'Checklist',
  'boards.cardBack.dueDate': 'Due date',
  'boards.cardBack.editLabel': 'Edit label',
  'boards.cardBack.enableColorblindMode': 'Enable colorblind friendly mode',
  'boards.cardBack.hideCheckedItems': 'Hide checked items',
  ...
  'boards.cardBack.markIncomplete': 'Mark this card incomplete ({title})',
  ...
  'boards.cardBack.showCheckedItems': 'Show checked items ({count})',
  ...
  'boards.cardLinks.actions': 'Linked entity actions for {title}',
  'boards.cardLinks.badge': 'Linked entities',
  'boards.cardLinks.createGoal': 'Create Goal',
  'boards.cardLinks.createStory': 'Create Story',
  'boards.cardLinks.createTask': 'Create Task',
  'boards.cardLinks.deleteEntity': 'Delete entity',
  'boards.cardLinks.deleteEntityLabel': 'Delete linked entity {title}',
  'boards.cardLinks.empty': 'No linked entities',
  'boards.cardLinks.goal': 'Goal',
  'boards.cardLinks.link': 'Link entity',
  'boards.cardLinks.linkToEntity': 'Link to Task / Story / Goal',
  'boards.cardLinks.loadFailed': 'Failed to load entities.',
  'boards.cardLinks.loading': 'Loading entities...',
  'boards.cardLinks.noResults': 'No matching entities',
  'boards.cardLinks.open': 'Open linked entity {title}',
  'boards.cardLinks.openAction': 'Open entity',
  ...
  'boards.cardLinks.taskBadge': 'Linked tasks',
  'boards.cardLinks.title': 'Linked entities',
  'boards.cardLinks.unlink': 'Unlink {title}',
  'boards.cardLinks.unlinkAction': 'Unlink',
  'boards.cardLinks.goalBadge': 'Linked goals',
  ...
  'boards.listActions.deleteList': 'Delete this list',
