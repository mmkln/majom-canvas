...
export const uk = {
  ...
  'existingPicker.goalQueryNoMatchingTags': 'Для {query} не знайдено жодного тега цілі.',
  'existingPicker.goalQueryConvertTagSuggestion': 'Перетворити поточний запит на теговий фільтр',
  ...
  'existingPicker.goalEmptyMixed': 'Не знайдено цілей для "{term}" у межах {tags}',
  ...
  'existingPicker.goalErrorTags': 'Не вдалося завантажити цілі, відфільтровані за {tags}',
  'existingPicker.goalErrorText': 'Не вдалося завантажити цілі для "{term}"',
  'existingPicker.goalSearchOmniboxPlaceholder': 'Шукати цілі або ввести #тег...',
