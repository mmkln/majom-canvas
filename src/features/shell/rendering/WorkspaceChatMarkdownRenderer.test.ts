...
import { WorkspaceChatMarkdownRenderer } from './WorkspaceChatMarkdownRenderer.ts';

describe('WorkspaceChatMarkdownRenderer', () => {
  afterAll(() => {
    window.close();
  });

  it('renders common markdown structures', () => {
    const renderer = new WorkspaceChatMarkdownRenderer();
