...
export function createWorkspaceChatTestSnapshot(
  overrides: Partial<WorkspaceChatCanvasSnapshot> = {}
): WorkspaceChatCanvasSnapshot {
  const snapshot: WorkspaceChatCanvasSnapshot = {
...
export function createWorkspaceChatTestMemory(
  overrides: Partial<WorkspaceChatMemoryState> = {}
