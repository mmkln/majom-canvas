...
import type { CanvasUserProfilePort } from './CanvasUserProfilePort.ts';
...
export class AuthController {
  ...
  constructor(
    ...
    private readonly userProfilePort: CanvasUserProfilePort
  ) {}
  ...
  public loadUserIfNeeded(force: boolean = false): void {
    ...
    this.userLoadSubscription?.unsubscribe();
    this.userLoadSubscription = this.userProfilePort.getUser().subscribe({
      next: (user: User) => {
        this.patchState({
          user,
          isUserLoading: false,
