...
export function buildAiAssistantReviewPrompt(
...
export function buildAiAssistantBreakdownPrompt(
...
export function buildAiAssistantStrategicPlanPrompt(
  selection: AiAssistantSelectionItem[]
): string {
...
export function buildAiAssistantClarifyPrompt(
  item: AiAssistantSelectionItem
): string {
  if (item.kind === 'goal') {
...
export function buildAiAssistantFillDetailsPrompt(
  selection: AiAssistantSelectionItem[]
): string {
  if (selection.length === 0) {
...
export function buildAiAssistantMissingPrompt(
  selection: AiAssistantSelectionItem[]
): string {
  if (selection.length === 0) {
...
export function buildAiAssistantNextStepsPrompt(
  selection: AiAssistantSelectionItem[]
): string {
  if (selection.length === 0) {
...
export function buildAiAssistantDuplicatePrompt(
  selection: AiAssistantSelectionItem[]
): string {
  if (selection.length === 0) {
...
export function buildAiAssistantRecentChangesPrompt(
  selection: AiAssistantSelectionItem[]
): string {
  if (selection.length === 0) {
...
export function buildAiAssistantIntentPrompt(
  intent: AiAssistantIntentKind,
  selection: AiAssistantSelectionItem[]
): string {
  switch (intent) {
    case 'review':
      return buildAiAssistantReviewPrompt(selection);
    case 'breakdown': {
      const item = selection[0];
      return item
        ? buildAiAssistantBreakdownPrompt(item)
        : buildAiAssistantReviewPrompt([]);
    }
    case 'dependencies':
      return buildAiAssistantDependencyPrompt(selection);
    case 'strategic_plan':
      return buildAiAssistantStrategicPlanPrompt(selection);
    case 'missing':
      return buildAiAssistantMissingPrompt(selection);
    case 'clarify': {
      const item = selection[0];
      return item
        ? buildAiAssistantClarifyPrompt(item)
        : buildAiAssistantFillDetailsPrompt([]);
    }
    case 'fill_details':
      return buildAiAssistantFillDetailsPrompt(selection);
  }
}
