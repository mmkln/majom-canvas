...
export class ToastProvider {
  ...
  constructor(options: ToastProviderOptions = {}) {
    ...
    const posClasses: Record<string, string> = {
      'top-right':
        'pointer-events-none fixed right-4 top-4 z-[260] flex w-[min(24rem,calc(100vw-2rem))] max-w-full flex-col gap-3',
      'top-left':
        'pointer-events-none fixed left-4 top-4 z-[260] flex w-[min(24rem,calc(100vw-2rem))] max-w-full flex-col gap-3',
      'bottom-right':
        'pointer-events-none fixed bottom-4 right-4 z-[260] flex w-[min(24rem,calc(100vw-2rem))] max-w-full flex-col-reverse gap-3',
      'bottom-left':
        'pointer-events-none fixed bottom-4 left-4 z-[260] flex w-[min(24rem,calc(100vw-2rem))] max-w-full flex-col-reverse gap-3',
    };
